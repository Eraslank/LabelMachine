...
namespace LabelMachine
{
    public class Startup
    {
        ...
        {
            services.Configure<LabelMachineDatabaseSettings>(
                Configuration.GetSection(nameof(LabelMachineDatabaseSettings)));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "LabelMachine API V1");
            });
